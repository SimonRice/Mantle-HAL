...
// Mantle-HAL
#define COCOAPODS_POD_AVAILABLE_Mantle_HAL
#define COCOAPODS_VERSION_MAJOR_Mantle_HAL 1
#define COCOAPODS_VERSION_MINOR_Mantle_HAL 1
#define COCOAPODS_VERSION_PATCH_Mantle_HAL 0
